...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Ajax Basics: Part II</title>
		<link rel="stylesheet" href="./css/styles.css" type="text/css" />
		<script src="./scripts/ajax-utils.js" type="text/javascript"></script>
		<script src="./scripts/ajax-basics-2.js" type="text/javascript"></script>
	</head>
	<body>
		<div align="center">
			<table border="5">
			...
			<fieldset>
				...
				<form action="#">
					<input type="button" value="Show Chicago Time"
						onclick='ajaxResult("show-time-in-city?city=Chicago", 
		                       "chicago-time")' />
				</form>
			...
			<fieldset>
				...
				<form action="#">
					<label>
						City:
						<input type="text" id="city-1" />
					</label>
					<br />
					<input type="button" value="Show City Time"
						onclick='showTimeInCity("city-1","city-1-time")' />
				</form>
